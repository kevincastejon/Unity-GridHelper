...
namespace TacticalDemo
{
    public class GridMap : MonoBehaviour
    {
        ...
        private void OnAttackMode()
        {
            ...
            Tile[] tilesOnRadius = Extraction.GetWalkableTilesInARadius(_map, CurrentCharacterTile, Mathf.FloorToInt(_maxDistanceAttack), false);
        ...
        private void OnTileEntered()
        {
            ...
            {
                if (Extraction.IsTileInARadius(CurrentCharacterTile, _hoveredTile, Mathf.FloorToInt(_maxDistanceAttack)))
                {
